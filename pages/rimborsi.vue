    ...
    <v-container fluid>
        ...
        <v-card class="mt-5 rounded-lg" elevation="5">
            ...
            <v-alert
                ...
                max-width="500"
            >
                I rimborsi andati a buon fine non verranno accreditati come credito welfare spendibile ma direttamente
            ...
            <v-card-text>
                ...
                <v-list v-else>
                    <v-list-item two-line v-for="item in refund" :key="item.id" class="mb-5">
                        ...
                        <p class="mt-3 font-weight-bold accent--text"> {{ item.value }}€</p>
                    </v-list-item>
                </v-list>
            </v-card-text>
        </v-card>
